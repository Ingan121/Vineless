...
export class PlayReadyRemote {
    ...
    async generateChallenge(pssh, extra) {
        ...
        const selected_remote_cdm_name = await RemoteCDMManager.getSelectedPRRemoteCDM(this.host);
        ...
        * */
        ...
        const sessionIdRemote = await remote_cdm.open();
        const newChallenge = await remote_cdm.get_license_challenge(sessionIdRemote, wrmHeader, false);
    ...
    async parseLicense(body, extra) {
        ...
        const wrmHeader = session.wrmHeader;
