...
export class Session {
    constructor(contentDecryptionModule, pssh, initDataType = "cenc") {
    ...
    createLicenseRequest(licenseType = LicenseType.STREAMING, android = false) {
        ...
        const content_id_data = {};
        if (this._webm) {
            content_id_data.webmKeyId = new LicenseRequest.ContentIdentification.WebmKeyId({
                header: this._pssh,
                licenseType: licenseType,
                requestId: request_id
            });
        } else {
            content_id_data.widevinePsshData = new LicenseRequest.ContentIdentification.WidevinePsshData({
                psshData: [this._pssh],
                licenseType: licenseType,
                requestId: request_id
            });
        ...
        const licenseRequest = new LicenseRequest({
            ...
            contentId: new LicenseRequest.ContentIdentification(content_id_data),
    ...
    _encryptClientIdentification(clientIdentification, signedServiceCertificate) {
        ...
        console.log("[Vineless]", "SERVICE_CERTIFICATE", serviceCertificate);
    ...
    getPSSH() {
        if (this._webm) {
            return uint8ArrayToHex(this._pssh)
        }
