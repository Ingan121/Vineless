...
export const license_protocol = $root.license_protocol = (() => {
    ...
    license_protocol.LicenseIdentification = (function() {
         ...
         */
        LicenseIdentification.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.LicenseIdentification();
        ...
        LicenseIdentification.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.LicenseIdentification)
                return object;
            let message = new $root.license_protocol.LicenseIdentification();
    ...
    license_protocol.License = (function() {
        ...
        License.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.License();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        License.verify = function verify(message) {
            ...
            if (message.id != null && message.hasOwnProperty("id")) {
                let error = $root.license_protocol.LicenseIdentification.verify(message.id);
                if (error)
                    return "id." + error;
            }
            if (message.policy != null && message.hasOwnProperty("policy")) {
                let error = $root.license_protocol.License.Policy.verify(message.policy);
                if (error)
                    return "policy." + error;
            }
            if (message.key != null && message.hasOwnProperty("key")) {
                ...
                for (let i = 0; i < message.key.length; ++i) {
                    let error = $root.license_protocol.License.KeyContainer.verify(message.key[i]);
                    if (error)
                        return "key." + error;
                }
            }
        ...
        License.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.License)
                return object;
            let message = new $root.license_protocol.License();
            if (object.id != null) {
        ...
        License.Policy = (function() {
            ...
            Policy.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.License.Policy();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            Policy.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.License.Policy)
                    return object;
                let message = new $root.license_protocol.License.Policy();
        ...
        License.KeyContainer = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            KeyContainer.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.License.KeyContainer();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            KeyContainer.verify = function verify(message) {
                ...
                if (message.requiredProtection != null && message.hasOwnProperty("requiredProtection")) {
                    let error = $root.license_protocol.License.KeyContainer.OutputProtection.verify(message.requiredProtection);
                    if (error)
                        return "requiredProtection." + error;
                }
                if (message.requestedProtection != null && message.hasOwnProperty("requestedProtection")) {
                    let error = $root.license_protocol.License.KeyContainer.OutputProtection.verify(message.requestedProtection);
                    if (error)
                        return "requestedProtection." + error;
                }
                if (message.keyControl != null && message.hasOwnProperty("keyControl")) {
                    let error = $root.license_protocol.License.KeyContainer.KeyControl.verify(message.keyControl);
                    if (error)
                ...
                if (message.operatorSessionKeyPermissions != null && message.hasOwnProperty("operatorSessionKeyPermissions")) {
                    let error = $root.license_protocol.License.KeyContainer.OperatorSessionKeyPermissions.verify(message.operatorSessionKeyPermissions);
                    if (error)
                ...
                if (message.videoResolutionConstraints != null && message.hasOwnProperty("videoResolutionConstraints")) {
                    ...
                    for (let i = 0; i < message.videoResolutionConstraints.length; ++i) {
                        let error = $root.license_protocol.License.KeyContainer.VideoResolutionConstraint.verify(message.videoResolutionConstraints[i]);
                        if (error)
            ...
            KeyContainer.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.License.KeyContainer)
                    return object;
                let message = new $root.license_protocol.License.KeyContainer();
                if (object.id != null)
            ...
            KeyContainer.KeyControl = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                KeyControl.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.License.KeyContainer.KeyControl();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                KeyControl.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.License.KeyContainer.KeyControl)
                        return object;
                    let message = new $root.license_protocol.License.KeyContainer.KeyControl();
            ...
            KeyContainer.OutputProtection = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                OutputProtection.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.License.KeyContainer.OutputProtection();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                OutputProtection.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.License.KeyContainer.OutputProtection)
                        return object;
                    let message = new $root.license_protocol.License.KeyContainer.OutputProtection();
                    switch (object.hdcp) {
                    default:
            ...
            KeyContainer.VideoResolutionConstraint = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                VideoResolutionConstraint.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.License.KeyContainer.VideoResolutionConstraint();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                VideoResolutionConstraint.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.License.KeyContainer.VideoResolutionConstraint)
                        return object;
                    let message = new $root.license_protocol.License.KeyContainer.VideoResolutionConstraint();
            ...
            KeyContainer.OperatorSessionKeyPermissions = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                OperatorSessionKeyPermissions.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.License.KeyContainer.OperatorSessionKeyPermissions();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                OperatorSessionKeyPermissions.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.License.KeyContainer.OperatorSessionKeyPermissions)
                        return object;
                    let message = new $root.license_protocol.License.KeyContainer.OperatorSessionKeyPermissions();
    ...
    license_protocol.LicenseRequest = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        LicenseRequest.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.LicenseRequest();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        LicenseRequest.verify = function verify(message) {
            ...
            if (message.clientId != null && message.hasOwnProperty("clientId")) {
                let error = $root.license_protocol.ClientIdentification.verify(message.clientId);
                if (error)
                    return "clientId." + error;
            }
            if (message.contentId != null && message.hasOwnProperty("contentId")) {
                let error = $root.license_protocol.LicenseRequest.ContentIdentification.verify(message.contentId);
                if (error)
            ...
            if (message.encryptedClientId != null && message.hasOwnProperty("encryptedClientId")) {
                let error = $root.license_protocol.EncryptedClientIdentification.verify(message.encryptedClientId);
                if (error)
        ...
        LicenseRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.LicenseRequest)
                return object;
            let message = new $root.license_protocol.LicenseRequest();
        ...
        LicenseRequest.ContentIdentification = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            ContentIdentification.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.LicenseRequest.ContentIdentification();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            ContentIdentification.verify = function verify(message) {
                ...
                if (message.widevinePsshData != null && message.hasOwnProperty("widevinePsshData")) {
                    ...
                    {
                        let error = $root.license_protocol.LicenseRequest.ContentIdentification.WidevinePsshData.verify(message.widevinePsshData);
                        if (error)
                ...
                if (message.webmKeyId != null && message.hasOwnProperty("webmKeyId")) {
                    ...
                    properties.contentIdVariant = 1;
                    {
                        let error = $root.license_protocol.LicenseRequest.ContentIdentification.WebmKeyId.verify(message.webmKeyId);
                        if (error)
                ...
                if (message.existingLicense != null && message.hasOwnProperty("existingLicense")) {
                    ...
                    properties.contentIdVariant = 1;
                    {
                        let error = $root.license_protocol.LicenseRequest.ContentIdentification.ExistingLicense.verify(message.existingLicense);
                        if (error)
                ...
                if (message.initData != null && message.hasOwnProperty("initData")) {
                    ...
                    properties.contentIdVariant = 1;
                    {
                        let error = $root.license_protocol.LicenseRequest.ContentIdentification.InitData.verify(message.initData);
                        if (error)
            ...
            ContentIdentification.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.LicenseRequest.ContentIdentification)
                    return object;
                let message = new $root.license_protocol.LicenseRequest.ContentIdentification();
            ...
            ContentIdentification.WidevinePsshData = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                WidevinePsshData.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.LicenseRequest.ContentIdentification.WidevinePsshData();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                WidevinePsshData.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.LicenseRequest.ContentIdentification.WidevinePsshData)
                        return object;
                    let message = new $root.license_protocol.LicenseRequest.ContentIdentification.WidevinePsshData();
                    if (object.psshData) {
            ...
            ContentIdentification.WebmKeyId = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                WebmKeyId.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.LicenseRequest.ContentIdentification.WebmKeyId();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                WebmKeyId.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.LicenseRequest.ContentIdentification.WebmKeyId)
                        return object;
                    let message = new $root.license_protocol.LicenseRequest.ContentIdentification.WebmKeyId();
            ...
            ContentIdentification.ExistingLicense = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                ExistingLicense.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.LicenseRequest.ContentIdentification.ExistingLicense();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                ExistingLicense.verify = function verify(message) {
                    ...
                    if (message.licenseId != null && message.hasOwnProperty("licenseId")) {
                        let error = $root.license_protocol.LicenseIdentification.verify(message.licenseId);
                        if (error)
                ...
                ExistingLicense.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.LicenseRequest.ContentIdentification.ExistingLicense)
                        return object;
                    let message = new $root.license_protocol.LicenseRequest.ContentIdentification.ExistingLicense();
            ...
            ContentIdentification.InitData = (function() {
                 ...
                 * @throws {$protobuf.util.ProtocolError} If required fields are missing
                 */
                InitData.decode = function decode(reader, length, error) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.LicenseRequest.ContentIdentification.InitData();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        if (tag === error)
                            break;
                ...
                InitData.fromObject = function fromObject(object) {
                    if (object instanceof $root.license_protocol.LicenseRequest.ContentIdentification.InitData)
                        return object;
                    let message = new $root.license_protocol.LicenseRequest.ContentIdentification.InitData();
    ...
    license_protocol.MetricData = (function() {
        ...
        MetricData.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.MetricData();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        MetricData.verify = function verify(message) {
            ...
            if (message.metricData != null && message.hasOwnProperty("metricData")) {
                ...
                for (let i = 0; i < message.metricData.length; ++i) {
                    let error = $root.license_protocol.MetricData.TypeValue.verify(message.metricData[i]);
                    if (error)
        ...
        MetricData.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.MetricData)
                return object;
            let message = new $root.license_protocol.MetricData();
        ...
        MetricData.TypeValue = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            TypeValue.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.MetricData.TypeValue();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            TypeValue.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.MetricData.TypeValue)
                    return object;
                let message = new $root.license_protocol.MetricData.TypeValue();
                switch (object.type) {
                default:
                    if (typeof object.type === "number") {
                        message.type = object.type;
    ...
    license_protocol.VersionInfo = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        VersionInfo.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.VersionInfo();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        VersionInfo.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.VersionInfo)
                return object;
            let message = new $root.license_protocol.VersionInfo();
    ...
    license_protocol.SignedMessage = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SignedMessage.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.SignedMessage();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SignedMessage.verify = function verify(message) {
            ...
            if (message.metricData != null && message.hasOwnProperty("metricData")) {
                if (!Array.isArray(message.metricData))
                    return "metricData: array expected";
                for (let i = 0; i < message.metricData.length; ++i) {
                    let error = $root.license_protocol.MetricData.verify(message.metricData[i]);
                    if (error)
                        return "metricData." + error;
                }
            }
            if (message.serviceVersionInfo != null && message.hasOwnProperty("serviceVersionInfo")) {
                let error = $root.license_protocol.VersionInfo.verify(message.serviceVersionInfo);
                if (error)
        ...
        SignedMessage.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.SignedMessage)
                return object;
            let message = new $root.license_protocol.SignedMessage();
            switch (object.type) {
            default:
                if (typeof object.type === "number") {
                    message.type = object.type;
    ...
    license_protocol.ClientIdentification = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ClientIdentification.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.ClientIdentification();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        ClientIdentification.verify = function verify(message) {
            ...
            if (message.clientInfo != null && message.hasOwnProperty("clientInfo")) {
                ...
                for (let i = 0; i < message.clientInfo.length; ++i) {
                    let error = $root.license_protocol.ClientIdentification.NameValue.verify(message.clientInfo[i]);
                    if (error)
            ...
            if (message.clientCapabilities != null && message.hasOwnProperty("clientCapabilities")) {
                let error = $root.license_protocol.ClientIdentification.ClientCapabilities.verify(message.clientCapabilities);
                if (error)
            ...
            if (message.deviceCredentials != null && message.hasOwnProperty("deviceCredentials")) {
                ...
                for (let i = 0; i < message.deviceCredentials.length; ++i) {
                    let error = $root.license_protocol.ClientIdentification.ClientCredentials.verify(message.deviceCredentials[i]);
                    if (error)
        ...
        ClientIdentification.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.ClientIdentification)
                return object;
            let message = new $root.license_protocol.ClientIdentification();
            switch (object.type) {
            default:
                if (typeof object.type === "number") {
                    message.type = object.type;
        ...
        ClientIdentification.NameValue = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            NameValue.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.ClientIdentification.NameValue();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            NameValue.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.ClientIdentification.NameValue)
                    return object;
                let message = new $root.license_protocol.ClientIdentification.NameValue();
                if (object.name != null)
        ...
        ClientIdentification.ClientCapabilities = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            ClientCapabilities.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.ClientIdentification.ClientCapabilities();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            ClientCapabilities.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.ClientIdentification.ClientCapabilities)
                    return object;
                let message = new $root.license_protocol.ClientIdentification.ClientCapabilities();
        ...
        ClientIdentification.ClientCredentials = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            ClientCredentials.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.ClientIdentification.ClientCredentials();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            ClientCredentials.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.ClientIdentification.ClientCredentials)
                    return object;
                let message = new $root.license_protocol.ClientIdentification.ClientCredentials();
                switch (object.type) {
                default:
                    if (typeof object.type === "number") {
                        message.type = object.type;
    ...
    license_protocol.EncryptedClientIdentification = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        EncryptedClientIdentification.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.EncryptedClientIdentification();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        EncryptedClientIdentification.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.EncryptedClientIdentification)
                return object;
            let message = new $root.license_protocol.EncryptedClientIdentification();
    ...
    license_protocol.DrmCertificate = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        DrmCertificate.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.DrmCertificate();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        DrmCertificate.verify = function verify(message) {
            ...
            if (message.encryptionKey != null && message.hasOwnProperty("encryptionKey")) {
                let error = $root.license_protocol.DrmCertificate.EncryptionKey.verify(message.encryptionKey);
                if (error)
        ...
        DrmCertificate.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.DrmCertificate)
                return object;
            let message = new $root.license_protocol.DrmCertificate();
            switch (object.type) {
            default:
                if (typeof object.type === "number") {
                    message.type = object.type;
        ...
        DrmCertificate.EncryptionKey = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            EncryptionKey.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.DrmCertificate.EncryptionKey();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            EncryptionKey.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.DrmCertificate.EncryptionKey)
                    return object;
                let message = new $root.license_protocol.DrmCertificate.EncryptionKey();
                if (object.publicKey != null)
                    if (typeof object.publicKey === "string")
                        $util.base64.decode(object.publicKey, message.publicKey = $util.newBuffer($util.base64.length(object.publicKey)), 0);
                    else if (object.publicKey.length >= 0)
    ...
    license_protocol.SignedDrmCertificate = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SignedDrmCertificate.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.SignedDrmCertificate();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SignedDrmCertificate.verify = function verify(message) {
            ...
            if (message.signer != null && message.hasOwnProperty("signer")) {
                let error = $root.license_protocol.SignedDrmCertificate.verify(message.signer);
                if (error)
                    return "signer." + error;
            }
        ...
        SignedDrmCertificate.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.SignedDrmCertificate)
                return object;
            let message = new $root.license_protocol.SignedDrmCertificate();
    ...
    license_protocol.WidevinePsshData = (function() {
        ...
        WidevinePsshData.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.WidevinePsshData();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        WidevinePsshData.verify = function verify(message) {
            ...
            if (message.entitledKeys != null && message.hasOwnProperty("entitledKeys")) {
                ...
                for (let i = 0; i < message.entitledKeys.length; ++i) {
                    let error = $root.license_protocol.WidevinePsshData.EntitledKey.verify(message.entitledKeys[i]);
                    if (error)
        ...
        WidevinePsshData.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.WidevinePsshData)
                return object;
            let message = new $root.license_protocol.WidevinePsshData();
            if (object.keyIds) {
        ...
        WidevinePsshData.EntitledKey = (function() {
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            EntitledKey.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.WidevinePsshData.EntitledKey();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            EntitledKey.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.WidevinePsshData.EntitledKey)
                    return object;
                let message = new $root.license_protocol.WidevinePsshData.EntitledKey();
    ...
    license_protocol.FileHashes = (function() {
        ...
        FileHashes.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.FileHashes();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        FileHashes.verify = function verify(message) {
            ...
            if (message.signatures != null && message.hasOwnProperty("signatures")) {
                ...
                for (let i = 0; i < message.signatures.length; ++i) {
                    let error = $root.license_protocol.FileHashes.Signature.verify(message.signatures[i]);
                    if (error)
        ...
        FileHashes.fromObject = function fromObject(object) {
            if (object instanceof $root.license_protocol.FileHashes)
                return object;
            let message = new $root.license_protocol.FileHashes();
            if (object.signer != null)
        ...
        FileHashes.Signature = (function() {
            ...
            Signature.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.license_protocol.FileHashes.Signature();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            Signature.fromObject = function fromObject(object) {
                if (object instanceof $root.license_protocol.FileHashes.Signature)
                    return object;
                let message = new $root.license_protocol.FileHashes.Signature();
